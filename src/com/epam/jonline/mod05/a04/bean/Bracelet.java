...
public class Bracelet extends Treasure implements Serializable {
    ...
    public Bracelet(String material, String name, String stones, double price) {
        super(name, price + 3);
    ...
    public String toString() {
        return material + " BRACELET with " + stones + " Price: " + getPrice();
    }
}
