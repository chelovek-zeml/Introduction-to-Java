...
public class Chain extends Treasure implements Serializable {
    ...
    public Chain(String material, String name, String stones, double price) {
        super(name, price + 4);
    ...
    public String toString() {
        return material + " CHAIN with " + stones + " Price: " + getPrice();
    }
}
